...
local Window = WindUI:CreateWindow({
    Title = "Purium Hub [By @hlck49] | Silent Assassin |", Icon = "door-open", Author = "Version : 1.7.0", Folder = "Purium_Silent-Assassin",
...
Window:Tag({ Title = "v1.7.0 (Perfect Nuke)", Icon = "github", Color = Color3.fromRGB(48, 255, 106), Radius = 10 })
...
local oldKickHook
oldKickHook = hookmetamethod(game, "__namecall", function(self, ...)
    local method = getnamecallmethod()
